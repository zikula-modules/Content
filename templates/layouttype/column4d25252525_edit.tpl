<table class="content-layout-edit">
    <tr>
        <td id="widget_col_0" class="content-area" colspan="4">
    ...
    <tr>
        ...
        <td id="widget_col_2" class="content-area" style="width: 25%">
        ...
        <td id="widget_col_4" class="content-area" style="width: 25%">
    ...
    <tr>
        <td id="widget_col_5" class="content-area" colspan="4">
