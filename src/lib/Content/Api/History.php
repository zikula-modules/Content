 ...
 * @version $Id: pnhistoryapi.php 406 2010-06-01 03:04:45Z drak $
...
class Content_Api_History extends Zikula_Api
{
    public function getPageVersions($args)
    {
        ...
        for ($i=0,$cou=count($versions); $i<$cou; ++$i)
        {
            ...
            $version['userName'] = $version['userId'] == 0 ? $this->__("Unknown user") : UserUtil::getPNUserField($version['userId'], 'uname');
        }
