 ...
 *
 * This is the base repository class for content item entities.
 */
abstract class AbstractContentItemRepository extends EntityRepository
{
    /**
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('contentItem', $qb, $parameters);
        }
