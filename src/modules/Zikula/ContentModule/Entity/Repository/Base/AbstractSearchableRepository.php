 ...
 *
 * This is the base repository class for searchable entities.
 */
abstract class AbstractSearchableRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'Zikula\ContentModule\Entity\SearchableEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'searchText';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'ZikulaContentModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'searchables', 'userid' => $userId];
     ...
     *
     * @return array|searchableEntity Retrieved data array or searchableEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved searchableEntity instances
     */
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('searchable', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('searchable', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of searchables to exclude (optional)
     *
     * @return boolean Result of this check, true if the given searchable does not already exist
     */
    ...
    {
        $qb->leftJoin('tbl.contentItem', 'tblContentItem');
