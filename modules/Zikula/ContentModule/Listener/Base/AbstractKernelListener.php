...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from content app';
     *     $event->getRequest()->attributes->set('ZikulaContentModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('ZikulaContentModule_test');`
     *     now `$testMessage` should be: `'Hello from content app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('content App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
