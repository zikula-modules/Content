...
class content_contenttypesapi_YouTubePlugin extends contentTypeBase
{
  ...
  function getName() { return 'youtube'; }
  function getTitle() { return _CONTENT_CONTENTENTTYPE_YOUTUBETITLE; }
  function getDescription() { return _CONTENT_CONTENTENTTYPE_YOUTUBEDESCR; }
  ...
  function isValid(&$data, &$message)
  {
    ...
    $message = _CONTENT_CONTENTENTTYPE_YOUTUBENOTVALIDURL;
    return false;
  }
}
