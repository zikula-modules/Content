...
class content_contenttypesapi_circaviePlugin extends contentTypeBase
{
  ...
  function getName() { return 'circavie'; }
  function getTitle() { return _CONTENT_CONTENTENTTYPE_CIRCAVIETITLE; }
  function getDescription() { return _CONTENT_CONTENTENTTYPE_CIRCAVIEDESCR; }
