...
class content_contenttypesapi_SlidesharePlugin extends contentTypeBase
{
  ...
  function getName() { return 'slideshare'; }
  function getTitle() { return _CONTENT_CONTENTENTTYPE_SLIDESHARETITLE; }
  function getDescription() { return _CONTENT_CONTENTENTTYPE_SLIDESHAREDESCR; }
  ...
  function isValid(&$data, &$message)
  {
    ...
    $message = _CONTENT_CONTENTENTTYPE_SLIDESHARENOTVALIDREF;
    return false;
  }
}
