...
class Content_LayoutType_BootstrapColumn3c6c3c3 extends Content_AbstractLayoutType
{
    ...
    function getTitle()
    {
        return $this->__('3 columns (6|3|3) Bootstrap');
    }
    function getDescription()
    {
        return $this->__('Twitter Bootstrap Layout: Header + three columns (col-md-6|col-md-3|col-md-3) + footer');
    }
