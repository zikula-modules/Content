...
class Content_LayoutType_BootstrapColumn3c3c3c6 extends Content_AbstractLayoutType
{
    ...
    function getTitle()
    {
        return $this->__('3 columns (3|3|6) Bootstrap');
    }
    function getDescription()
    {
        return $this->__('Twitter Bootstrap Layout: Header + three columns (col-md-3|col-md-3|col-md-6) + footer');
    }
