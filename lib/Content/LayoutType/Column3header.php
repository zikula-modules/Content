...
class Content_LayoutType_Column3header extends Content_AbstractLayoutType
{
    ...
    function getTitle()
    {
        return $this->__('3 columns (33|33|33)');
    }
    function getDescription()
    {
        return $this->__('Header + three columns (33|33|33) + footer');
    }
